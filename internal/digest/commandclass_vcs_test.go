...
func TestClassifyVCSCategories(t *testing.T) {
	cases := []struct {
		...
		{"branch long delete", "git branch --delete old", true, []string{"vcs.mutate"}},
		{"branch long move", "git branch --move old new", true, []string{"vcs.mutate"}},
		{"branch long copy", "git branch --copy old new", true, []string{"vcs.mutate"}},
		{"branch long force", "git branch --force reset-me", true, []string{"vcs.mutate"}},
